...
class LineManager:
    def __init__(self, render):
        self.render = render
        self.lines = {}  # Dictionary to hold line data
    ...
    def update_line(self, name, points, color=(1, 0, 0, 1), thickness=2.0):
        ...
        line_geom_node = lines.create(False)  # This returns a GeomNode
        node_path = NodePath(line_geom_node)  # Create a new NodePath for the GeomNode
        node_path.reparentTo(self.render)  # Reparent the new NodePath to render
